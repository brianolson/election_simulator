...
static int _IntArg(int argc, const char** argv, int* argi,
...
// return { 0: not claimed, 1: claimed, -1: error }
static int _DoubleArg(int argc, const char** argv, int* argi,
...
static int _StringArg(int argc, const char** argv, int* argi,
			   const char* optname, const char** value) {
	const char* arg = argv[*argi];
	// skip "-" or "--"
	if (*arg == '-') {
		arg = arg + 1;
